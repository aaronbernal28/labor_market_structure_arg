...
rule export_zenodo_graph:
	...
	output:
		graph="data/graphs/{dataset}/{class_}/zenodo_{class_}_{weight_function}_{alpha}_{algorithm}.gexf"
	log:
		"data/graphs/{dataset}/{class_}/zenodo_{class_}_{weight_function}_{alpha}_{algorithm}.log"
	script:
